...
type EventProps = Partial<Pick<IFormsortWebEmbed, 'onFlowLoaded' | 'onFlowClosed' | 'onFlowFinalized' | 'onRedirect'>>;
interface LoadProps {
  clientLabel: string;
  flowLabel: string;
  variantLabel?: string;
...
export type Props = LoadProps & EventProps;
...
const attachEventListenersToEmbed = (embed: IFormsortWebEmbed, events: EventProps): void => {
...
const onMount = (containerRef: React.RefObject<HTMLDivElement>, props: Props): void => {
...
const EmbedFlow: React.FunctionComponent<Props> = (props) => {
